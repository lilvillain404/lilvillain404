...
### 📌Немного о себе
 ...
 Мой интерес к данным появился ещё в университете, где я ежедневно работала с огромными массивами информации, искала в них закономерности. Эта работа заложила сильную фундаментальную базу в **математике** и **статистике**, которая стала основой моего аналитического мышления. Тогда я поняла, что меня захватывает сам процесс анализа: систематизация хаоса и поиск скрытых взаимосвязей. Этот интерес остается со мной по сей день, и я активно продолжаю изучать новые технологии, инструменты и программы.
  ***
...
<div>
  ...
  <img src="https://img.icons8.com/color/64/000000/pycharm.png" alt="PyCharm" title="PyCharm" style="margin:5px; border-radius:12px; background:#f8f9fa; padding:8px;"/>
  <img src="https://img.icons8.com/fluency/64/000000/jupyter.png" alt="Jupyter Notebook" title="Jupyter Notebook" style="margin:5px; border-radius:12px; background:#f8f9fa; padding:8px;"/>
</div>
...
* Регулярно углубляю свои знания, изучаю новые программы.
 ***
